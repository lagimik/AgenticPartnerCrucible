...
A Collection of resources for Microsoft practice building around sustainability. For a view of other Workloads, please see the [Taxonomy](./Taxonomy).
...
[How agentic AI is transforming renewable energy operations](https://www.microsoft.com/en-us/microsoft-cloud/blog/energy-and-resources/2026/04/21/how-agentic-ai-is-transforming-renewable-energy-operations-realizing-the-energy-frontier/) | Energy and Resources article describing autonomous AI agents for renewable resource assessment, asset performance monitoring, procurement, compliance, logistics, forecasting, trading, and grid optimization. | Microsoft Cloud Blog
