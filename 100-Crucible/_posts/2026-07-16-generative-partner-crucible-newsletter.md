---
title: Generative Partner Crucible - for the week ending 2026-07-16
date: 2026-07-16
...
* 🎓 Partner skilling resources now include LevelUp learning journeys 
* 🚀 Partner Accelerators and Demos
* 🧭 Partner Skilling Hub additions make microskilling and AI-assisted skilling discovery easier to find

## Deep links

* [Learning Journeys](https://www.skillupwithlevelup.com/journeys): Curated Microsoft LevelUp learning paths and guided journeys help partners structure role-based and workload-based practice development. (Microsoft LevelUp)
* [Accelerators and Demos](https://skillupwithlevelup.com/dealreadyaccelerators): Microsoft LevelUp Deal Ready Accelerators provide partner enablement assets for preparing customer-ready solution conversations and demos. (Microsoft LevelUp)
...
s- 🧾 Policy-to-Proof reframes AI governance as an operating loop from policy to audit evidence
...
* 🖥️ The upgrade canvas gives teams an interactive view of assessment, planning, tasks, changes, failures, and results
* 🔁 Modernization guidance now spans GitHub Copilot App, Visual Studio, VS Code, and GitHub Copilot CLI
...
* 📊 Power BI Dev Camp now points to Microsoft Learn developer resources
* 🧪 Power BI Dev Sandbox was added as an embedded analytics sandbox environment
...
* 🛡️ APIM-as-gateway patterns make AI Foundry deployments easier to govern
* ✅ Policy-to-Proof adds a full AI governance reference architecture to Security and Data & AI pages
* 🔐 Security curation now connects AI gateways, zero-trust agent patterns, Purview, Defender, Entra, Agent 365, and ACS

## Deep links

* [Using APIM as the Gateway for Azure AI Foundry: AI Adoption to Governance](https://techcommunity.microsoft.com/blog/appsonazureblog/from-ai-adoption-to-ai-governance---using-apim-as-the-gateway-for-azure-ai-found/4536247): Azure API Management is positioned as a governance layer and gateway for Azure AI Foundry deployments, enabling enterprise-grade security, rate limiting, policy enforcement, and operational controls. (Apps on Azure Blog)
