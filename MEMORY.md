...
- The user's Shakespeare Second Brain vault is `C:\Users\mamoris\OneDrive - Microsoft\Documents\Clawpilot\AgenticPartnerCrucible`, maintained as an LLM-assisted personal wiki.
- Shakespeare's vault follows the OpenClaw/Karpathy-style pattern: raw source preservation, durable wiki notes, schema/operating rules, linked pages, and dated logs.
- Recent Shakespeare work centers on Microsoft partner and AI knowledge management, including Azure AI Foundry/Foundry Labs ingest, document-processing tool-selection notes, and newsletter-style partner summaries from the latest ingest.
