...
:----- | :---------- | :----
[MDASH - Multi-Model Agentic Scanning Harness (Private Preview)](https://forms.office.com/pages/responsepage.aspx?id=v4j5cvGGr0GRqy180BHbR5n91RGSMY5MoMjm9pNflCtUODBFQ0NKTllWTkRWRTY3TU0zQkg5S1JXSiQlQCN0PWcu&route=shorturl) | Microsoft's AI-powered security platform using 100+ specialized agents to find and validate software vulnerabilities at scale. In its debut, MDASH found 16 previously unknown Windows vulnerabilities (four rated critical) patched in May 2026's Patch Tuesday. | Microsoft (Private Preview)
[Running OpenClaw safely: identity, isolation, and runtime risk](https://www.microsoft.com/en-us/security/blog/2026/02/19/running-openclaw-safely-identity-isolation-runtime-risk/) | This post explains how the two supply chains inherent to self-hosted agents — untrusted code (skills and extensions) and untrusted instructions (external text inputs) — converge into a single execution loop. We examine how this design creates compounding risk in workstation environments, provide a representative compromise chain, and outline deployment, monitoring, and hunting guidance aligned to Microsoft Security controls, including Microsoft Defender XDR. For organizations that still choose to evaluate OpenClaw, we include a minimum safe operating posture. | Microsoft Security Blog
[Microsoft Data Security Index Report](https://www.microsoft.com/en-us/security/blog/2026/01/29/new-microsoft-data-security-index-report-explores-secure-ai-adoption-to-protect-sensitive-data/) | Data Security Index report’s key findings that relate to generative AI and how they are being operationalized at Microsoft.| Microsoft Security Blog
...
[Microsoft Entra ID named leader in KuppingerCole’s Access Management Leadership Compass](https://techcommunity.microsoft.com/t5/microsoft-entra-azure-ad-blog/microsoft-entra-id-named-leader-in-kuppingercole-s-access/ba-p/3827394) | Microsoft has been recognized as an overall leader in Access Management, as we view identity as the trust fabric for the digital ecosystem, a critical ground zero from which all downstream interactions originate and rely on.  | Tech Community[KuppingerCole Leadership Compass for Generative AI Defense](https://techcommunity.microsoft.com/blog/microsoft-security-blog/microsoft-named-an-overall-leader-in-kuppingercole-leadership-compass-for-genera/4478093) | Microsoft is recognized as an overall leader in the KuppingerCole Leadership Compass for Generative AI Defense (GAD). This recognition reinforces Microsoft's enterprise-ready Security and Governance capabilities for AI, with comprehensive protection across AI apps, agents, platforms, and infrastructure. | KuppingerCole
...
[Security Advisors Program Member Sign-up](https://forms.cloud.microsoft/pages/responsepage.aspx?id=v4j5cvGGr0GRqy180BHbR5n91RGSMY5MoMjm9pNflCtUOEtZNTJBTkhZUElISVVEQkNXTDJNVTNKVyQlQCN0PWcu&route=shorturl) | Voluntary Microsoft Security Advisors membership sign-up for Management, Entra, Purview, and Threat Protection advisor programs, with opportunities for product-roadmap meetings, private previews, engineering feedback, and customer-to-customer learning under confidentiality obligations. | Microsoft Forms
...
[Cyber Pulse: AI Security Report](https://www.microsoft.com/en-us/security/security-insider/emerging-trends/cyber-pulse-ai-security-report) | Security Insider report/video on the business risk created when AI agents scale faster than organizations can observe them; frames agent protection around observability, governance, security, and Zero Trust principles. | Security Insider
[Securing AI Agents at Runtime](https://techcommunity.microsoft.com/blog/microsoft-security-blog/securing-ai-agents-at-runtime-real-time-protection-and-threat-detection-for-micr/4541255) | Microsoft Defender threat detection and real-time protection for Agent 365 agents, WorkIQ, and custom MCP servers, combining SOC investigation with inline enforcement. | Tech Community
...
[SFI Patterns and Practices Library](https://www.microsoft.com/en-us/trust-center/security/secure-future-initiative/patterns-and-practices) | Explore actionable patterns and practices from the Secure Future Initiative (SFI). Scale securely following SFI patterns and practices based on Microsoft's tested security insights organized by the six SFI pillars: Protect identities and secrets, Protect tenants and isolate systems, Protect networks, Protect engineering systems, Monitor and detect cyberthreats, and Accelerate response and remediation. | Microsoft Trust Center
...
[Microsoft Agent 365 SDK Samples and Prompts](https://github.com/microsoft/Agent365-Samples) | Open-source sample agents and prompts for Microsoft Agent 365 SDK across .NET, Python, and Node.js/TypeScript with production-oriented patterns. | GitHub
...
[Microsoft Agent 365 runtime protection and threat detection](https://techcommunity.microsoft.com/blog/microsoft-security-blog/securing-ai-agents-at-runtime-real-time-protection-and-threat-detection-for-micr/4541255) | Microsoft Defender runtime security for supported Agent 365 agents and tooling servers, including public-preview threat detection and generally available real-time protection. | Tech Community
